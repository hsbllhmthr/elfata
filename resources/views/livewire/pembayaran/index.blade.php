        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h5 class="mb-0">Data Pembayaran &nbsp;&nbsp;<a class="btn bg-gradient-dark mb-0 me-4 text-end" href="{{ route('tambah-pembayaran') }}"><i class="material-icons text-sm">add</i></a></h5>
                </div>
                            ...
                            <tr>
                                <td>                                    
                                    <div class="d-flex align-items-center">
                                        <p class=" font-weight-normal ms-2 mb-0">{{ $pembayaran->id }}</p>
                                    </div>
                                </td>
                                <td class="text-sm font-weight-normal">
                                    <span class="my-2 ">{{ $pembayaran->santri->nama }}</span>
                                </td>
                                <td class="text-sm font-weight-normal">
                                    <span class="my-2 ">{{ $pembayaran->kelompok }}</span>
                                </td>
                                <td class="text-sm font-weight-normal">
                                    {{ $pembayaran->tanggal }}
                                </td>
                                <td class="text-sm font-weight-normal">
                                    <span class="my-2 ">{{ $pembayaran->jumlah }}</span>
                                </td>
                                <td class="text-sm font-weight-normal">
                                    <span class="my-2 ">{{ $pembayaran->sisa }}</span>
                                </td>
                                <td class="text-sm font-weight-normal">
                                    <span class="my-2 ">{{ $pembayaran->ket }}</span>
                                </td>
                                <td class="text-sm font-weight-normal align-items-center">                                    
                                    <a href="{{ route('ubah-pembayaran', $pembayaran) }}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Ubah">
                                        <i class="material-icons text-secondary position-relative text-lg">drive_file_rename_outline</i>
                                    </a>
                                    <a href="javascript:;" data-bs-toggle="tooltip" onclick="confirm('Ingin menghapus data ini?') || event.stopImmediatePropagation()" wire:click="destroy({{ $pembayaran->id }})" data-bs-original-title="Hapus">
