        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h5 class="mb-0">Ubah Galeri Foto</h5>
                ...
                <div class="card-body">
                    <form wire:submit.prevent="update" class='d-flex flex-column align-items-center'
                        ...
                        <div class="position-relative">
                            <div class="position-relative preview">
                                ...
                                <span class="h-12 w-12 rounded-full overflow-hidden bg-gray-100">
                                    ...
                                    @else
                                    <img src="/storage/{{($galeri->foto)}}" alt="avatar">
                                    @endif</span>
                        ...
                        <div class="form-group col-12 col-md-6 mt-3">
                            ...
                            <label for="juduls">Judul Foto</label>
                            <input wire:model.lazy="galeri.judul" type="text" class="form-control border border-2 p-2"
                                id="juduls" placeholder="Judul Foto">
                                @error('galeri.judul')
                                <p class='text-danger inputerror'>{{ $message }} </p>
                                @enderror
                        </div>                        
